...
#
# Generated by Vivado on Sat Apr 27 19:43:54 +0800 2019
...
# Script info
echo -e "inst_rom.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_12 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_rom xil_defaultlib.inst_rom xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/vivado/Vivado/2018.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
